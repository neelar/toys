...
class ToysControllerTest < ActionController::TestCase
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post :create, toy: { description: @toy.description, manufacture: @toy.manufacture, name: @toy.name, price: @toy.price }
    end
  ...
  test "should update toy" do
    patch :update, id: @toy, toy: { description: @toy.description, manufacture: @toy.manufacture, name: @toy.name, price: @toy.price }
    assert_redirected_to toy_path(assigns(:toy))
  end
